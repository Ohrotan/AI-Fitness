...
public class AdminProgramManageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_program_manage);

        ListView listView = (ListView)findViewById(R.id.listView);

        AdminProgramManageActivity.ListAdapter adapter = new AdminProgramManageActivity.ListAdapter();
        //adapter에 data값
        adapter.addItem(new Member_reg_program("다이어트1", "★★★★☆","★★★★☆","30 명","","","","한관욱"));
        adapter.addItem(new Member_reg_program("다이어트2", "★★★★☆","★★★★☆","30 명","","","","조란"));
        adapter.addItem(new Member_reg_program("다이어트3", "★★★★☆","★★★★☆","30 명","","","","최승혁"));
        adapter.addItem(new Member_reg_program("다이어트4", "★★★★☆","★★★★☆","30 명","","","","류제호"));
    ...
    class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            Admin_reg_programView view = new Admin_reg_programView(getApplicationContext());
            ...
            view.setTrainer_id(item.getTrainer_id());

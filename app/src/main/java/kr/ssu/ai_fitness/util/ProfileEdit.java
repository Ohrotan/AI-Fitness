...
public class ProfileEdit {
    ...
    public String upload(InputStream is, Member info) {
        ...
        try {
            URL url = new URL(URLs.URL_EDITPROFILE);//URL 생성
            ...
            dos.writeBytes("Content-Disposition: form-data; name=\"id\"  " +twoHyphens + boundary + lineEnd);
            dos.writeBytes("Content-Type: text/plain" + lineEnd);
            dos.writeBytes(lineEnd);
            dos.writeBytes(String.valueOf(info.getId()));
            dos.writeBytes(lineEnd);
